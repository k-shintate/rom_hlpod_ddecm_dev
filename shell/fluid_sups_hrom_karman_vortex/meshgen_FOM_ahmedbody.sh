...
rm -r cond.dat
./../../../test_thermal/bin/cmd2cond "#density_array" double 1 0.68435754189e5
mv cond.dat density.dat
./../../../test_thermal/bin/cmd2cond "#viscosity_array" double 1 1
mv cond.dat viscosity.dat

./../../../test_thermal/bin/cmd2cond "#target_density" double 1 0.68435754189e5
...
./../../../test_thermal/bin/cmd2cond "#time_spacing" double 1 8.0e-5 "#output_interval" int 1 10  "#finish_time" double 1 200 "#mat_max_iter" int 1 100000 "#mat_epsilon" double 1 1.0e-8 "#density" double 1 0.68435754189e5 "#viscosity" double 1 1
