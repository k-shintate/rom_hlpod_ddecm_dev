...
./../../../test_thermal/bin/cmd2cond "#time_spacing" double 1 0.01 "#output_interval" int 1 10  "#finish_time" double 1 200 "#mat_max_iter" int 1 100000 "#mat_epsilon" double 1 1.0e-7
