...
directory_online="result_fluid_sups_karman_vortex/online_${nm}-${np2}-${nd}"
...
echo "mkdir -p result_fluid_sups_karman_vortex/tmp" >> $fname
echo "cp -r result_fluid_sups_karman_vortex/${nm}-${np}-${nd} result_fluid_sups_karman_vortex/tmp" >> $fname
echo "mv result_fluid_sups_karman_vortex/tmp/${nm}-${np}-${nd} $directory_online" >> $fname
