...
./../../../test_thermal/submodule/monolis/submodule/gedatsu/bin/gedatsu_simple_mesh2graph_convertor -i elem.dat -o graph.dat

./../../solvers/diff/meshgen_ST 1 4 ./node.dat ./elem.dat ./st
...
./../../solvers/diff/st_partition_postprocessor 4 \
  ./st_meta.dat \
  ./graph.dat \
  ./st_elem.dat \
  ./st_elem_map.dat \
