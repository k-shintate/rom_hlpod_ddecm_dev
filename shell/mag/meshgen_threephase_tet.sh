...
gmsh -3 -format msh2 ../../solvers/mag/threephase_transformer/gmsh/threephase_transformer_fine.geo -o sphere2.msh
...
mv ./mesh_tmp/CORE_IRON_tetra_connectivity.dat ./elem_iron.dat

mv ./mesh_tmp/COIL_1_tetra_connectivity.dat ./elem_widing1.dat
mv ./mesh_tmp/COIL_2_tetra_connectivity.dat ./elem_widing2.dat
mv ./mesh_tmp/COIL_3_tetra_connectivity.dat ./elem_widing3.dat
