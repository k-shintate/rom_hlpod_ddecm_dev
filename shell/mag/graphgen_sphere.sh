...
./../../../test_thermal/bin/cmd2cond "#time_spacing" double 1 0.0000001 "#output_interval" int 1 100  "#finish_time" double 1 1.0
...
python3 ./../../shell/mag/bool_elem.py ./elem_inner.dat ./elem_air.dat ./elem.dat ./elem_bool.dat
