...
gmsh -3 ../../plot/gmsh/sphere_air_tet.geo -o sphere.msh
...
python3 ../../plot/mesh_io/elem_to_node.py ./mesh_tmp/OuterBoundary_triangle_connectivity.dat ./mesh_tmp/OuterSphere_triangle_node.dat
python3 ../../plot/mesh_io/elem_to_node.py ./mesh_tmp/OuterSphere_triangle_connectivity.dat ./mesh_tmp/InnerSphere_triangle_node.dat

mv ./mesh_tmp/All_node_coordinates.dat ./node.dat
mv ./mesh_tmp/All_tetra_connectivity.dat ./elem.dat
mv ./mesh_tmp/Shell_tetra_connectivity.dat ./elem_inner.dat
mv ./mesh_tmp/OuterAir_tetra_connectivity.dat ./elem_air.dat

python3 ../../plot/mesh_io/node_to_bc.py ./mesh_tmp/OuterSphere_triangle_node.dat ./D_bc.dat 1 0
python3 ../../plot/mesh_io/node_to_bc.py ./mesh_tmp/InnerSphere_triangle_node.dat ./InnerSphere_quad_bc.dat 1 0
