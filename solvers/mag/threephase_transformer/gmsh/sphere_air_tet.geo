// TEAM11 cubed-sphere TETRA: conductive shell (a->b) + outer air (b->R)
// [修正] Recombineを無効化して四面体メッシュを出力するように変更
SetFactory("Built-in");
...
// Recombine Surface { sOut0, sIn0, sSide0_0, sSide0_1, sSide0_2, sSide0_3 }; // ★コメントアウト: 四角形化を無効化

Transfinite Volume { v0 } = { pOut0_0, pOut0_1, pOut0_2, pOut0_3, pIn0_0, pIn0_1, pIn0_2, pIn0_3 };
// Recombine Volume { v0 }; // ★コメントアウト: 六面体化を無効化
...
// Recombine  Surface { sFar0, sSideAir0_0, sSideAir0_1, sSideAir0_2, sSideAir0_3 }; // ★コメントアウト

Transfinite Volume  { vOut0 } = { pOut0_0, pOut0_1, pOut0_2, pOut0_3, pFar0_0, pFar0_1, pFar0_2, pFar0_3 };
// Recombine  Volume   { vOut0 }; // ★コメントアウト
...
// Recombine Surface { sOut1, sIn1, sSide1_0, sSide1_1, sSide1_2, sSide1_3 }; // ★コメントアウト

Transfinite Volume { v1 } = { pOut1_0, pOut1_1, pOut1_2, pOut1_3, pIn1_0, pIn1_1, pIn1_2, pIn1_3 };
// Recombine Volume { v1 }; // ★コメントアウト
...
// Recombine  Surface { sFar1, sSideAir1_0, sSideAir1_1, sSideAir1_2, sSideAir1_3 }; // ★コメントアウト

Transfinite Volume  { vOut1 } = { pOut1_0, pOut1_1, pOut1_2, pOut1_3, pFar1_0, pFar1_1, pFar1_2, pFar1_3 };
// Recombine  Volume   { vOut1 }; // ★コメントアウト
...
// Recombine Surface { sOut2, sIn2, sSide2_0, sSide2_1, sSide2_2, sSide2_3 }; // ★コメントアウト

Transfinite Volume { v2 } = { pOut2_0, pOut2_1, pOut2_2, pOut2_3, pIn2_0, pIn2_1, pIn2_2, pIn2_3 };
// Recombine Volume { v2 }; // ★コメントアウト
...
// Recombine  Surface { sFar2, sSideAir2_0, sSideAir2_1, sSideAir2_2, sSideAir2_3 }; // ★コメントアウト

Transfinite Volume  { vOut2 } = { pOut2_0, pOut2_1, pOut2_2, pOut2_3, pFar2_0, pFar2_1, pFar2_2, pFar2_3 };
// Recombine  Volume   { vOut2 }; // ★コメントアウト
...
// Recombine Surface { sOut3, sIn3, sSide3_0, sSide3_1, sSide3_2, sSide3_3 }; // ★コメントアウト

Transfinite Volume { v3 } = { pOut3_0, pOut3_1, pOut3_2, pOut3_3, pIn3_0, pIn3_1, pIn3_2, pIn3_3 };
// Recombine Volume { v3 }; // ★コメントアウト
...
// Recombine  Surface { sFar3, sSideAir3_0, sSideAir3_1, sSideAir3_2, sSideAir3_3 }; // ★コメントアウト

Transfinite Volume  { vOut3 } = { pOut3_0, pOut3_1, pOut3_2, pOut3_3, pFar3_0, pFar3_1, pFar3_2, pFar3_3 };
// Recombine  Volume   { vOut3 }; // ★コメントアウト
...
// Recombine Surface { sOut4, sIn4, sSide4_0, sSide4_1, sSide4_2, sSide4_3 }; // ★コメントアウト

Transfinite Volume { v4 } = { pOut4_0, pOut4_1, pOut4_2, pOut4_3, pIn4_0, pIn4_1, pIn4_2, pIn4_3 };
// Recombine Volume { v4 }; // ★コメントアウト
...
// Recombine  Surface { sFar4, sSideAir4_0, sSideAir4_1, sSideAir4_2, sSideAir4_3 }; // ★コメントアウト

Transfinite Volume  { vOut4 } = { pOut4_0, pOut4_1, pOut4_2, pOut4_3, pFar4_0, pFar4_1, pFar4_2, pFar4_3 };
// Recombine  Volume   { vOut4 }; // ★コメントアウト
...
// Recombine Surface { sOut5, sIn5, sSide5_0, sSide5_1, sSide5_2, sSide5_3 }; // ★コメントアウト

Transfinite Volume { v5 } = { pOut5_0, pOut5_1, pOut5_2, pOut5_3, pIn5_0, pIn5_1, pIn5_2, pIn5_3 };
// Recombine Volume { v5 }; // ★コメントアウト
...
// Recombine  Surface { sFar5, sSideAir5_0, sSideAir5_1, sSideAir5_2, sSideAir5_3 }; // ★コメントアウト

Transfinite Volume  { vOut5 } = { pOut5_0, pOut5_1, pOut5_2, pOut5_3, pFar5_0, pFar5_1, pFar5_2, pFar5_3 };
// Recombine  Volume   { vOut5 }; // ★コメントアウト
...
// Mesh options
Mesh.ElementOrder = 1; // 1:Linear Tet(4), 2:Quadratic Tet(10)
Mesh.RecombineAll = 0; // 念のため0にしておく
Mesh.Optimize = 1;
Mesh.Format = 2;
Geometry.Tolerance = 1e-12;

// Usage:
//   gmsh -3 team11_shell_outerair_tetra.geo