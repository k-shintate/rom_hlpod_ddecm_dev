...
python3 mesh_io/elem_to_bc.py ./mesh_tmp/Right_wall_quad_connectivity.dat  ./mesh_tmp/Right_wall_quad_bc.dat 3 0 0 0        #slip wall #一時的にnonslip wall の処置
python3 mesh_io/elem_to_bc.py ./mesh_tmp/Left_wall_quad_connectivity.dat  ./mesh_tmp/Left_wall_quad_bc.dat 3 0 0 0          #slip wall
...
python3 mesh_io/elem_to_bc.py ./mesh_tmp/Top_wall_quad_connectivity.dat  ./mesh_tmp/Top_wall_quad_bc.dat 3 0 0 0            #slip wall

# 境界条件の削除
python3 mesh_io/fileter_index.py ./mesh_tmp/Right_wall_quad_bc.dat ./mesh_tmp/filtered_Right_wall_quad_bc.dat 0 2           #slip wall の場合、接線方向の境界条件を削除
...
python3 mesh_io/merge_bc.py ./mesh_tmp/filtered_Right_wall_quad_bc.dat \
    ./mesh_tmp/filtered_Left_wall_quad_bc.dat ./mesh_tmp/filtered_Bottom_wall_quad_bc.dat \
