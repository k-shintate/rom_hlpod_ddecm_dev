...
mv  ./mesh_karman_vortex/Nitsche_wall_quad_connectivity.dat ./mesh_karman_vortex/surf.dat  #surf.dat
...
python3 mesh_io/merge_bc.py ./mesh_tmp/filtered_Top_wall_quad_bc.dat \
    ./mesh_tmp/Cylinder_wall_quad_bc.dat ./mesh_tmp/filtered_Upstream_lower_wall_quad_bc.dat ./mesh_tmp/filtered_Bottom_wall_quad_bc.dat \
